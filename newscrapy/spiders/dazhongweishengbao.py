...
class mySpider(CrawlSpider):
    name = "dazhongweishengbao"
    newspapers = "大众卫生报"
    allowed_domains = ['epaper.voc.com.cn']
    
    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y-%m/%d")
        template = "https://epaper.voc.com.cn/dzwsb/html/{date}/node_78.htm"
        for d in dates:
            yield FormRequest(template.format(date = d))
#https://epaper.voc.com.cn/dzwsb/html/2020-07/21/node_78.htm
#https://epaper.voc.com.cn/dzwsb/html/2020-07/21/content_1464438.htm?div=-1
    rules = (
