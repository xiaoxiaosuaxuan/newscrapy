...
class mySpider(CrawlSpider):
    name = "dongyajingmaonews"
    newspapers = "东亚经贸新闻"
    allowed_domains = ['dnews.dyxw.com']

    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m/%d")
        template = "http://dnews.dyxw.com/pc/paper/layout/{date}/node_01.html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#http://dnews.dyxw.com/pc/paper/layout/202209/02/node_01.html
#http://dnews.dyxw.com/pc/paper/c/202209/02/content_37031.html
    rules = (
