...
class mySpider(CrawlSpider):
    ...
    def start_requests(self):    
        ...
        template = "http://szb.handannews.com.cn/wbpaper/pc/layout/{date}/node_01.html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#http://szb.handannews.com.cn/rbpaper/pc/content/202208/19/content_204544.html
#http://szb.handannews.com.cn/rbpaper/pc/layout/202208/19/node_04.html
    rules = (
