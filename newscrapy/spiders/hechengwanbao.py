...
class mySpider(CrawlSpider):
    name = "hechengwanbao"
    newspapers = "鹤城晚报"
    allowed_domains = ['hcwb.dbw.cn']
    
    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m%d")
        template = "https://hcwb.dbw.cn/Html/szbz/{date}/szbzA1.Html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#https://hcwb.dbw.cn/Html/szbz/20210309/szbzA1.Html
#https://hcwb.dbw.cn/Html/szbz/20210309/szbz31623.Html
