...
class mySpider(CrawlSpider):
    name = "hegangwanbao"
    newspapers = "鹤岗晚报"
    allowed_domains = ['hgwb.dbw.cn']
    
    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m%d")
        template = "https://hgwb.dbw.cn/Html/szbz/{date}/szbzA1.Html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#https://hgwb.dbw.cn/Html/szbz/20181211/szbzA1.Html
#https://hgwb.dbw.cn/Html/szbz/20181211/szbz15702.Html
