...
class mySpider(CrawlSpider):
    name = "jilindaily"
    newspapers = "吉林日报"
    allowed_domains = ['jlrbszb.cnjiwang.com']

    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m/%d")
        template = "http://jlrbszb.cnjiwang.com/pc/paper/layout/{date}/node_01.html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#http://jlrbszb.cnjiwang.com/pc/paper/layout/202201/14/node_01.html
#http://jlrbszb.cnjiwang.com/pc/paper/c/202201/14/content_134288.html
    rules = (
