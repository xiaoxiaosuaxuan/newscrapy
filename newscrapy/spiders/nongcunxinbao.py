...
class mySpider(CrawlSpider):
    name = "nongcunxinbao"
    newspapers = "农村新报"
    allowed_domains = ['ncxbepaper.hubeidaily.net']

    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m/%d")
        template = "https://ncxbepaper.hubeidaily.net/pc/column/{date}/node_01.html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#https://ncxbepaper.hubeidaily.net/pc/column/202212/16/node_01.html
#https://ncxbepaper.hubeidaily.net/pc/content/202212/16/content_204103.html
    rules = (
