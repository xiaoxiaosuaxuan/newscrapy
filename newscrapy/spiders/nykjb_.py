...
class mySpider(CrawlSpider):
    name = "nykjb"
    newspapers = "农业科技报"
    allowed_domains = ['eb.nkb.com.cn']
#http://eb.nkb.com.cn/nykjb/20230413/html/index.htm
#http://eb.nkb.com.cn/nykjb/20230413/html/page_03.htm
#http://eb.nkb.com.cn/nykjb/20230413/html/content_20230413001002.htm
    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m%d")
        template = "http://eb.nkb.com.cn/nykjb/{date}/html/index.htm"
        for d in dates:
    ...
    def parse_item(self, response):
        try:
            ...
            url = response.url
            date = re.search('nykjb/(\d+)', url).group(1)
