...
class mySpider(CrawlSpider):
    name = "qiqihaerdaily"
    newspapers = "齐齐哈尔日报"
    allowed_domains = ['qqhaerrb.dbw.cn']
    
    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m%d")
        template = "https://qqhaerrb.dbw.cn/Html/szbz/{date}/szbzA1.Html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#https://qqhaerrb.dbw.cn/Html/szbz/20210309/szbzA2.Html
#https://qqhaerrb.dbw.cn/Html/szbz/20210309/szbz39270.Html
