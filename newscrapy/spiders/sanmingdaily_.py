...
class mySpider(CrawlSpider):
    name = "sanmingdaily"
    newspapers = "三明日报"
    allowed_domains = ['smrb.smnet.com.cn']

    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m/%d")
        template = "http://smrb.smnet.com.cn/pc/layout/{date}/node_1.html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#http://smrb.smnet.com.cn/pc/layout/content/202208/21/content_126423.html
#http://smrb.smnet.com.cn/pc/layout/202208/21/node_1.html
    rules = (
