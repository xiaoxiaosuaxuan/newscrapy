...
class mySpider(CrawlSpider):
    name = "sanxiadaily"
    newspapers = "三峡日报"
    allowed_domains = ['epaper.cn3x.com.cn']

    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m/%d")
        template = "http://epaper.cn3x.com.cn/sxrb/column/{date}/colA1.html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#http://epaper.cn3x.com.cn/sxrb/column/202208/31/colA1.html
#http://epaper.cn3x.com.cn/sxrb/content/202208/31/c231655.html
    rules = (
