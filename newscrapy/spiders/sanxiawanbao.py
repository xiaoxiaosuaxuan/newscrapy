...
class mySpider(CrawlSpider):
    name = "sanxiawanbao"
    newspapers = "三峡晚报"
    allowed_domains = ['sxwbepaper.hubeidaily.net']

    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m/%d")
        template = "https://sxwbepaper.hubeidaily.net/pc/column/{date}/node_02.html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#https://sxwbepaper.hubeidaily.net/pc/column/202203/02/node_02.html
#https://sxwbepaper.hubeidaily.net/pc/content/202203/02/content_156712.html
    rules = (
