...
class mySpider(CrawlSpider):
    name = "shiyouguandaobao"
    newspapers = "石油管道报"
    allowed_domains = ['106.37.204.40']

    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m/%d")
        template = "http://106.37.204.40:28080/sygdbpaper/pc/layout/{date}/node_1.html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#http://106.37.204.40:28080/sygdbpaper/pc/layout/202208/12/node_1.html
