...
class mySpider(CrawlSpider):
    name = "suihuawanbao"
    newspapers = "绥化晚报"
    allowed_domains = ['www.suihuaxw.org.cn']

    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m/%d")
        template = "http://www.suihuaxw.org.cn/paper/shwb/pc/layout/{date}/node_01.html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#http://www.suihuaxw.org.cn/paper/shwb/pc/layout/202208/26/node_01.html
#http://www.suihuaxw.org.cn/paper/shwb/pc/content/202208/26/content_56450.html
    rules = (
    ...
    def parse_item(self, response):
        try:
            ...
            imgs = response.xpath("//*[@id='ScroLeft']//img/@src").getall()
