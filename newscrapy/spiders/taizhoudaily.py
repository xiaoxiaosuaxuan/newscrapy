...
class mySpider(CrawlSpider):
    ...
    def start_requests(self):    
        ...
        template = "http://paper.taizhou.com.cn/taizhou/tzrb/pc/layout/{date}/node_01.html"
        for d in dates:
            yield FormRequest(template.format(date = d))

    rules = (
        Rule(LinkExtractor(allow=('taizhou/tzrb/pc/layout/\d+/\d+/node\w+.html'))),
        Rule(LinkExtractor(allow=('taizhou/tzrb/pc/content/\d+/\d+/content\w+.html')), callback="parse_item")
    )
