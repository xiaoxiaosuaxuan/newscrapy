...
class mySpider(CrawlSpider):
    name = "xiangyangwanbao"
    newspapers = "襄阳晚报"
    allowed_domains = ['xywb.hj.cn']

    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y%m/%d")
        template = "https://xywb.hj.cn/pc/col/{date}/node_01.html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#https://xywb.hj.cn/pc/col/202208/26/node_01.html
#https://xywb.hj.cn/pc/con/202208/26/content_2037682.html
    rules = (
