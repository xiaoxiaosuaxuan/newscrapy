...
class mySpider(CrawlSpider):
    name = "xinyangdaily"
    newspapers = "信阳日报"
    allowed_domains = ['ribao.xyxww.com.cn']
    
    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y-%m/%d")
        template = "https://ribao.xyxww.com.cn/html/{date}/node_2.htm"
        for d in dates:
            yield FormRequest(template.format(date = d))
#https://ribao.xyxww.com.cn/html/2022-08/19/node_2.htm
#https://ribao.xyxww.com.cn/html/2022-08/19/content_114673.htm
    rules = (
