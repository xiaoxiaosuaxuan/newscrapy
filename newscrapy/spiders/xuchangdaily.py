...
class mySpider(CrawlSpider):
    ...
    def start_requests(self):
        ...
        template = "http://szb.21xc.com/xcrb/PC/layout/{date}/col01.html"
        for d in dates:
            yield FormRequest(template.format(date = d))
#http://szb.21xc.com/xcrb/PC/layout/202211/08/col01.html
#http://szb.21xc.com/xcrb/PC/con/202211/08/c120540.html
    rules = (
