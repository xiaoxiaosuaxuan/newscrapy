...
class mySpider(CrawlSpider):
    name = "zhanjiangwanbao1"
    newspapers = "湛江晚报"
    allowed_domains = ['szb.gdzjdaily.com.cn']

    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y-%m/%d")
        template = "http://szb.gdzjdaily.com.cn/zjwb/html/{date}/node_2.htm"
        for d in dates:
            yield FormRequest(template.format(date = d))
#http://szb.gdzjdaily.com.cn/zjwb/html/2015-05/06/content_.htm
#http://szb.gdzjdaily.com.cn/zjwb/html/2015-05/06/node_181.htm
    rules = (
