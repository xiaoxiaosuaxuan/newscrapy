...
class mySpider(CrawlSpider):
    name = "zhengzhouwanbao"
    newspapers = "郑州晚报"
    allowed_domains = ['zzwb.zynews.cn']
    
    def start_requests(self):
        dates = dateGen(self.start, self.end, "%Y-%m/%d")
        template = "https://zzwb.zynews.cn/html/{date}/node_102.htm"
        for d in dates:
            yield FormRequest(template.format(date = d))
#https://zzwb.zynews.cn/html/2022-08/25/node_102.htm
#https://zzwb.zynews.cn/html/2022-08/25/content_1331526.htm
    rules = (
