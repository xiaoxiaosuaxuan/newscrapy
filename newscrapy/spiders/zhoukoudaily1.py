...
class mySpider(CrawlSpider):
    ...
    def start_requests(self):    
        ...
        template = "http://www.zhld.com/zkrb/html/{date}/node_41.htm"
        for d in dates:
            yield FormRequest(template.format(date = d))
#http://www.zhld.com/zkrb/html/2017-12/30/node_41.htm
#http://www.zhld.com/zkrb/html/2017-12/30/content_7626117.htm
    rules = (
